# Travelling Salesman
# Genetic Algorthm for TSP1 longest path
# run 2
...
if __name__ == "__main__":
    ...
    dis = []
    disevals = []
    evals  = list(range(1001))
    del evals[0]
    shortest = []
    for q in range(0,1000001):
        combination = comb
